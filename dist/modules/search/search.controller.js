...
let SearchController = class SearchController {
    ...
    semanticSearch(body) {
        return __awaiter(this, void 0, void 0, function* () {
            const results = yield this.service.semanticSearch({
                queryText: body.queryText,
                userLat: body.userLat,
                userLon: body.userLon,
                limit: 60,
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: "Search inventory (keyword + FTS search)" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Search inventory (AI semantic search)" }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nearby_dto_1.NearbyDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Explore nearby inventory (no query)" }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
