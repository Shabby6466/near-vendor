import { Controller, Post, Get, Delete, Body, Param, Req, UseGuards, Query, ParseFloatPipe } from '@nestjs/common';
...
export class WishlistController {
    ...
    async getUserWishes(@Req() req: any) {
        return await this.wishlistService.getUserWishes(req.user.id);
    }
    ...
    async exploreDemand(
        ...
        return await this.wishlistService.exploreLocalDemand(lat, lon, radius);
    }
}
